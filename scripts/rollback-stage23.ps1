...
$original = Join-Path $root ".codex-artifacts/stage23-original"
$modified = Join-Path $root ".codex-artifacts/stage23-modified"
$files = @("internal/app/app.go", "internal/core/scheduler.go", "internal/core/scheduler_test.go", "internal/download/ftp/ftp.go", "internal/download/ftp/ftp_test.go", "README.md")
