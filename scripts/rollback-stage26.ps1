...
$original = Join-Path $root ".codex-artifacts/stage26-original"
$modified = Join-Path $root ".codex-artifacts/stage26-modified"
$files = @("internal/ui/app.go", "internal/ui/dispatcher.go", "internal/ui/notifications_test.go", "README.md")
...
Write-Output "ROLLBACK=PASS (UI source, test and README; user data and packages untouched)"
