...
$original = Join-Path $root ".codex-artifacts/stage24-original"
$modified = Join-Path $root ".codex-artifacts/stage24-modified"
$files = @("internal/download/ftp/ftp.go", "internal/download/ftp/ftp_test.go", "README.md")
